...
class LoginController extends AbstractController
{
    ...
    public function login(Request $request,  SessionInterface $session, EntityManagerInterface $entityManager)
    {
        try {
            ...
            return new JsonResponse(['error' => 'Se produjo un error al iniciar sesión: ' . $e->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function logout( SessionInterface $session, EntityManagerInterface $entityManager)
    {
        try {
            ...
            return new JsonResponse(['error' => 'Se produjo un error al cerrar sesión: ' . $e->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function registrar(Request $request, EntityManagerInterface $entityManager, SessionInterface $session): Response{
        try {
            ...
            return new JsonResponse(['error' => 'Se produjo un error al registrar el usuario: ' . $e->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
