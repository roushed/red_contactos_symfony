...
class MiPerfilController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager, Request $request, SessionInterface $session): Response
    {
        try {
            ...
            return new Response('Ocurrió un error al cargar la página del perfil.', 500);
        }
        }
        ...
        public function guardarDatos(EntityManagerInterface $entityManager, Request $request, SessionInterface $session): Response
        {
            try {
                ...
                return new Response('Ocurrió un error al guardar los datos del perfil.', 500);
            }
        ...
        public function editarPost(Request $request, int $id, EntityManagerInterface $entityManager, SessionInterface $session): Response
        {
            try {
                ...
                return new Response('Ocurrió un error al editar el post.', 500);
            }
        }
        ...
        public function editarActividad(Request $request, int $id, EntityManagerInterface $entityManager, SessionInterface $session): Response
        {
            try {
                ...
                return new Response('Ocurrió un error al editar la actividad.', 500);
            }
        }
        ...
        public function guardarImagenes(Request $request, EntityManagerInterface $entityManager): Response
        {
            ...
            return new Response('Ocurrió un error al guardar las imágenes.', 500);
        }
        ...
        public function eliminarImagen(int $id, Request $request, EntityManagerInterface $entityManager): Response
        {
            try {
                ...
                return new Response('Ocurrió un error al eliminar la imagen.', Response::HTTP_INTERNAL_SERVER_ERROR);
            }
        }
        ...
        public function eliminarPost(int $id, EntityManagerInterface $entityManager): JsonResponse
        {
            try {
                ...
                return new JsonResponse(['message' => 'Ocurrió un error al eliminar el post.'], Response::HTTP_INTERNAL_SERVER_ERROR);
            }
        }
        ...
        public function eliminarActividad(int $id, EntityManagerInterface $entityManager): JsonResponse
        {
            try {
                ...
                return new JsonResponse(['message' => 'Ocurrió un error al eliminar la actividad.'], Response::HTTP_INTERNAL_SERVER_ERROR);
            }
        }
        ...
        #[Route('/eliminar_usuario', name: 'eliminar_usuario', methods: ['POST'])]
            public function eliminarUsuario(Request $request, EntityManagerInterface $entityManager, SessionInterface $session): Response
            {
                try {
                    ...
                    return new Response('Ocurrió un error al eliminar el usuario.', Response::HTTP_INTERNAL_SERVER_ERROR);
                }
            }
